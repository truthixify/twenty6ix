...
import { Share2, ExternalLink, Crown, Home, CheckSquare, Coins, Trophy, Info, Settings } from 'lucide-react'
                            ...
                            <TabsContent value='info' className='space-y-6'>
                                {isAdmin ? (
                                    ...
                                    <div className="max-w-4xl">
                                        <div className="mb-6">
                                            <h2 className="text-2xl font-bold">About TWENTY6IX</h2>
                                            <p className="text-muted-foreground">Learn about the platform and maximize your XP earnings.</p>
                                        </div>
                                                ...
                                                <CardContent>
                                                    <div className="space-y-3 text-sm">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                <div className="font-medium">Phase 1: Launch</div>
                                                                <div className="text-muted-foreground">Early Bird NFTs, Daily Claims, Social Tasks</div>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                                                            <div>
                                                                <div className="font-medium">Phase 2: Growth</div>
                                                                <div className="text-muted-foreground">Silver & Gold NFTs, Enhanced Referrals</div>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                                                            <div>
                                                                <div className="font-medium">Phase 3: Scale</div>
                                                                <div className="text-muted-foreground">Platinum NFTs, Advanced Features</div>
                                                            </div>
                                                        </div>
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                                                            <div>
                                                                <div className="font-medium">Phase 4: Token</div>
                                                                <div className="text-muted-foreground">TGE, Governance, Advanced Rewards</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </CardContent>
                            ...
                            <Card>
                                ...
                                <CardContent className='space-y-4'>
                                    <div className='space-y-2'>
                                        ...
                                        <div className='flex justify-between text-sm'>
                                            <span className='text-muted-foreground'>XP from Referrals:</span>
                                            <span className='font-medium text-green-600'>0 XP</span>
                                        </div>
                                    </div>
                                    <Button
                                        variant='outline'
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Earn 20 XP for each friend who joins using your code (max 15 referrals).
                                    </p>
                                </CardContent>
                            </Card>
                        </TabsContent>
